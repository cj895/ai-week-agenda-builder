...
function buildSkeleton(days){
  ...
  d2Slots.forEach(([st,en],si)=>{d2Grid[si].forEach(([loc,tr,ty])=>{ss.push(slot(D2,st,en,ty,tr,loc))})});
  ...
  d3Slots.forEach(([st,en],si)=>{d3Grid[si].forEach(([loc,tr,ty])=>{ss.push(slot(D3,st,en,ty,tr,loc))})});
  ss.push(slot(D3,"13:00","13:30","Networking","networking",L8,"Networking Lunch"));
  return ss;
}

function mkAtlantaSessions(days){
  ...
  fill(D2,"09:15",L0,{title:"What Happens After the Demo: A Real Look at AI, Process, and Work That Actually Ships",sponsor:"CRZY Design",description:"Stephen Gates pulls back the curtain on how AI is actually being used in real client work.",topicTags:["Implementation","Case Studies","Business Outcomes"],audienceTags:["Executive","Practitioner"]});
  ...
  fill(D2,"11:40",L0,{title:"Atlanta\u2019s Advantage: Why This City Will Lead AI"});fill(D2,"11:40",L1,{title:"The AI Governance Gap: Why Most Companies Aren\u2019t Ready"});fill(D2,"11:40",L2,{title:"The AI Conversation Chain: Why Brands Disappear After the First Prompt"});fill(D2,"11:40",L3,{title:"The New Risks Every Organization Needs to Understand",sponsor:"Axe.AI"});fill(D2,"11:40",L4,{title:"The Hidden Costs of Bad AI Execution"});fill(D2,"11:40",L5,{title:"What Every Workforce Needs to Embed in Their Culture"});fill(D2,"11:40",L6,{title:"What\u2019s in Your AI Stack?"});fill(D2,"11:40",L7,{title:"Moving from AI Experiments to Real Business Value"});
  fill(D2,"12:20",L0,{title:"Deepfakes and the Death of Trust"});fill(D2,"12:20",L1,{title:"Tales from the Trenches: The AI Incidents No CEO Wants to Experience"});fill(D2,"12:20",L2,{title:"From Data to Demand: AI Is Changing Customer Acquisition"});fill(D2,"12:20",L3,{title:"Protecting Data, Models, and Workflows",sponsor:"Axe.AI"});fill(D2,"12:20",L4,{title:"Tackling AI in Manufacturing"});fill(D2,"12:20",L5,{title:"How Leaders Prepare Teams for AI Literacy",sponsor:"USAII"});fill(D2,"12:20",L6,{title:"How to Turn Event Leads into Revenue Using AI"});fill(D2,"12:20",L7,{title:"AI in Healthcare: What\u2019s Working Right Now"});
  fill(D2,"13:40",L0,{title:"The Death of the American Salesman",sponsor:"AIprl Assist"});fill(D2,"13:40",L1,{title:"Operationalizing AI: Strategy, Culture, and Real Deployment",sponsor:"Nexigen"});fill(D2,"13:40",L2,{title:"Your AI Is Only as Smart as Your Data: Is Yours Ready?",sponsor:"CapGemini"});fill(D2,"13:40",L3,{title:"Ready or Not? How America\u2019s AI Rules Will Change How We Hire, Build and Deploy AI"});fill(D2,"13:40",L4,{title:"The Human Side of AI: Trust, Leadership, and Change"});fill(D2,"13:40",L5,{title:"Where Should You Actually Use AI?"});fill(D2,"13:40",L6,{title:"AI Is Changing Customer Experience"});fill(D2,"13:40",L7,{title:"AI in Fintech: Real-World Applications"});
  fill(D2,"14:20",L0,{title:"AI Adoption Gap: Enterprise vs. SMB"});fill(D2,"14:20",L1,{title:"The SMB AI Playbook: Making AI Stick"});fill(D2,"14:20",L2,{title:"Your Website Is Losing 97% of Buyers \u2014 and How AI Agents Fix It"});fill(D2,"14:20",L3,{title:"AI in the War Room"});fill(D2,"14:20",L4,{title:"The Future of AI Isn\u2019t Chatbots, It\u2019s Invisible Systems"});fill(D2,"14:20",L5,{title:"Film / Creative AI"});fill(D2,"14:20",L6,{title:"AI in Education: Building the Next Workforce"});
  fill(D2,"15:00",L0,{title:"Skills for Thrills: Why Context Beats Commands in AI Development"});fill(D2,"15:00",L1,{title:"Why Your ICP Is Wrong"});fill(D2,"15:00",L2,{title:"The AI-Powered Marketing Stack"});fill(D2,"15:00",L3,{title:"Infrastructure Wars"});fill(D2,"15:00",L4,{title:"Will AI Replace More Jobs Than It Creates?"});fill(D2,"15:00",L5,{title:"Start Fast or Start Right?"});
  fill(D3,"10:00",L0,{title:"Welcome to Day 3 \u2014 How Do We Implement?",sponsor:"Enterprise Technology Association"});fill(D3,"10:15",L0,{title:"Reality Bites: AI Governance in the Field",description:"Jodi Daniels and Justin Daniels discuss practical AI governance challenges."});fill(D3,"10:45",L0,{title:"Protecting Georgia\u2019s Children in the Age of AI",sponsor:"Enterprise Technology Association"});
  fill(D3,"11:40",L0,{title:"Inside a $2B Transformation: Modernizing Aramark at Scale"});fill(D3,"11:40",L1,{title:"When Your Eyes & Ears Are Powered by AI"});fill(D3,"11:40",L2,{title:"What\u2019s Real vs Hype in AI Right Now?"});fill(D3,"11:40",L3,{title:"How to Make AI a Daily Business Habit"});fill(D3,"11:40",L4,{title:"AI Governance vs Speed: Who Wins?"});fill(D3,"11:40",L5,{title:"How to Leverage AI: Agentic Coding Tools"});fill(D3,"11:40",L6,{title:"What\u2019s Blocking Your AI Initiatives Right Now?",sponsor:"Nexigen"});fill(D3,"11:40",L7,{title:"Where Is Healthcare Broken and AI Making a Difference?"});
  fill(D3,"12:20",L0,{title:"How Enterprise Teams Are Adopting AI \u2014 The Hard Decisions"});fill(D3,"12:20",L1,{title:"How to Stay Human in the Age of Intelligent Machines"});fill(D3,"12:20",L2,{title:"From Prototype to Production \u2014 Building AI Apps That Work"});fill(D3,"12:20",L3,{title:"AI in the Flow of Work: Models Into Operational Advantage",sponsor:"CapGemini"});fill(D3,"12:20",L4,{title:"Vendors vs. In-House: Buy the Stack vs. Build"});fill(D3,"12:20",L5,{title:"Building IP in the Age of Generative AI"});fill(D3,"12:20",L6,{title:"Where Is AI Actually Driving Revenue Right Now?"});fill(D3,"12:20",L7,{title:"AI Risk Roundtable: Builder, Buyer, or Regulator?"});
  fill(D3,"13:40",L0,{title:"Robots Are Ready. Are Your Teams?"});fill(D3,"13:40",L1,{title:"Who Should Own AI Risk: Builder, Buyer, or Regulator?"});fill(D3,"13:40",L2,{title:"Building AI Products with Gen AI"});fill(D3,"13:40",L3,{title:"Building AI for the 99%: What Deployments Taught Us"});fill(D3,"13:40",L4,{title:"What to Watch When AI Goes Live: Models, Drift, and Risk"});fill(D3,"13:40",L5,{title:"What Game Design Teaches Us About AI"});
  fill(D3,"14:20",L0,{title:"Blue Collar AI 2.0: Office Manager to Autonomous Operator"});fill(D3,"14:20",L1,{title:"The AI Talent Gap: What Companies Need vs What Exists"});fill(D3,"14:20",L2,{title:"A Step-by-Step Guide to Building Your First GenAI App"});fill(D3,"14:20",L3,{title:"Red Teaming AI: Stress-Testing Models Before Attackers Do",sponsor:"AXE.AI"});fill(D3,"14:20",L4,{title:"AI Isn\u2019t Failing \u2014 Our Learning Models Are",sponsor:"USAII"});fill(D3,"14:20",L5,{title:"How AI Is Rewriting Search and What It Means for Your Brand"});
  fill(D3,"15:00",L0,{title:"How to Eliminate Busywork and Scale Without Hiring"});fill(D3,"15:00",L1,{title:"The Small Business GenAI Playbook"});fill(D3,"15:00",L2,{title:"Governed by Design: AI Governance Workshop"});fill(D3,"15:00",L3,{title:"AI Governance in Practice: Risk Without Slowing Innovation",sponsor:"Nexigen"});fill(D3,"15:00",L4,{title:"AI, Creativity, and Community: Building Inclusive Tech"});fill(D3,"15:00",L5,{title:"Is AI Strengthening Security \u2014 or Breaking It?"});
  return ss;
}
...
.saving{position:fixed;bottom:20px;right:20px;background:var(--prussian);color:var(--aqua);font-family:'DM Sans',sans-serif;font-size:11px;font-weight:700;padding:8px 16px;border-radius:25px;z-index:200;opacity:0;transition:opacity .3s;pointer-events:none}
...
.sn{font-weight:800;font-size:20px;color:var(--spectrum)}.sn.warn{color:#F59E0B}
...
export default function AgendaBuilder(){
  ...
  const[fEmpty,setFEmpty]=useState("all");
  ...
  useEffect(()=>{(async()=>{
    ...
    if(evRows&&evRows.length>0){
      ...
      const loaded=evRows.map(e=>({id:e.id,name:e.name,dates:e.dates,days:e.days,sessions:(sessRows||[]).filter(s=>s.event_id===e.id).map(fromDb)}));
      setEvents(loaded);setEid(loaded[0].id);setADay(loaded[0].days[1]?.id||loaded[0].days[0].id);
    } else {
      // First run — seed Atlanta
      ...
      const evId="atlanta-2026";
      await supabase.from("events").insert({id:evId,name:"Atlanta",dates:days.map(d=>d.id),days});
      const ss=mkAtlantaSessions(days);
      const dbRows=ss.map(s=>toDb(s,evId));
      // Insert in batches of 50
      for(let i=0;i<dbRows.length;i+=50){await supabase.from("sessions").insert(dbRows.slice(i,i+50))}
      setEvents([{id:evId,name:"Atlanta",dates:days.map(d=>d.id),days,sessions:ss}]);
      setEid(evId);setADay(days[1].id);
    }
    setLoading(false);
  })()},[]);
  ...
  // ═══ SAVE SESSION (upsert to Supabase) ═══
  const save=async(s)=>{
    setEvents(p=>p.map(e=>e.id===eid?{...e,sessions:e.sessions.find(x=>x.id===s.id)?e.sessions.map(x=>x.id===s.id?s:x):[...e.sessions,s]}:e));
    setModal(false);setEdit(null);flash();
    await supabase.from("sessions").upsert(toDb(s,eid));
  };

  // ═══ DELETE SESSION ═══
  const del=async(id)=>{
    setEvents(p=>p.map(e=>e.id===eid?{...e,sessions:e.sessions.filter(x=>x.id!==id)}:e));
    setModal(false);setEdit(null);flash();
  ...
  // ═══ DUPLICATE SESSION ═══
  const dup=async(s)=>{
    const n={...s,id:uid(),title:s.title?(s.title+" (Copy)"):"",speakers:[...(s.speakers||[])],topicTags:[...(s.topicTags||[])],audienceTags:[...(s.audienceTags||[])],locked:false};
    setEvents(p=>p.map(e=>e.id===eid?{...e,sessions:[...e.sessions,n]}:e));flash();
    await supabase.from("sessions").insert(toDb(n,eid));
  };

  // ═══ CREATE EVENT ═══
  const createEv=async(name,d1,d2,d3)=>{
    ...
    const evId=uid();
    const ss2=buildSkeleton(ds);
    await supabase.from("events").insert({id:evId,name,dates:[d1,d2,d3],days:ds});
    const dbRows=ss2.map(s=>toDb(s,evId));
    for(let i=0;i<dbRows.length;i+=50){await supabase.from("sessions").insert(dbRows.slice(i,i+50))}
    setEvents(p=>[...p,{id:evId,name,dates:[d1,d2,d3],days:ds,sessions:ss2}]);
    setEid(evId);setADay(ds[1].id);setNeModal(false);flash();
  };

  // ═══ RESET SKELETON ═══
  const resetSkeleton=async()=>{
    if(!ev||!confirm("Reset "+ev.name+" to empty skeleton? This deletes all session data."))return;
    const ss2=buildSkeleton(ev.days);
    await supabase.from("sessions").delete().eq("event_id",eid);
    const dbRows=ss2.map(s=>toDb(s,eid));
    for(let i=0;i<dbRows.length;i+=50){await supabase.from("sessions").insert(dbRows.slice(i,i+50))}
    setEvents(p=>p.map(e=>e.id===eid?{...e,sessions:ss2}:e));flash();
  };
  ...
  return(
    ...
    <div className="sb">
      ...
      <div style={{flex:1}}/>
      {ev&&<button className="b bg bs" onClick={resetSkeleton}>Reset Skeleton</button>}
    </div>
    <div className="fb">
...
function SModal({s:init,days,isNew,onSave,onDel,onDup,onClose}){
  ...
  const doDel=async()=>{if(!confirm("Delete?"))return;setBusy(true);await onDel(s.id);setBusy(false)};
  const doDup=async()=>{setBusy(true);await onDup(s);onClose();setBusy(false)};
  return(
    ...
    <div className="ml">
      ...
      <div className="mf">
        <div style={{display:"flex",gap:6}}>
          {!isNew&&!s.locked&&<button className="b bd bs" onClick={doDel} disabled={busy}>Delete</button>}
          {!isNew&&<button className="b bg bs" onClick={doDup} disabled={busy}>Duplicate</button>}
        </div>
        <div style={{display:"flex",gap:6}}>
...
function NEModal({onCreate,onClose}){
  ...
  const go=async()=>{setBusy(true);await onCreate(name.trim(),d1,d2,d3);setBusy(false)};
  return(
    <div className="mo" onClick={e=>{if(e.target===e.currentTarget)onClose()}}>
    <div className="nem">
      <h2>Create New Event</h2>
      <p style={{fontSize:12,color:"var(--t2)",marginBottom:20,fontFamily:"'DM Sans',sans-serif"}}>A full conference skeleton will auto-populate. Just fill in the details.</p>
      <div className="fg">
      ...
      <div style={{display:"flex",gap:8,justifyContent:"flex-end",marginTop:20}}>
        <button className="b bg bs" onClick={onClose}>Cancel</button>
        <button className="b bp bs" disabled={!name.trim()||busy} onClick={go}>{busy?"Creating...":"Create Event"}</button>
      </div>
    </div></div>);
}
